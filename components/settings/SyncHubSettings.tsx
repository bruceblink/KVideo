      ...
      <div className="space-y-3">
        <label className="block space-y-1.5">
          ...
          <div className="relative">
            ...
            <input value={endpoint} onChange={(event) => { setEndpoint(event.target.value); setSaved(false); }} placeholder={DEFAULT_SYNCHUB_ENDPOINT} inputMode="url" className="w-full pl-9 pr-3 py-2 bg-(--glass-bg) border border-(--glass-border) rounded-lg text-sm text-(--text-color) focus:outline-none focus:border-(--accent-color)" />
          </div>
        </label>
        <label className="block space-y-1.5">
