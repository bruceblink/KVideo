...
const DEFAULT_SOURCE = {
  repository: 'bruceblink/KVideo',
  branch: 'main',
  manifestUrl: 'https://raw.githubusercontent.com/bruceblink/KVideo/main/app-release.json',
  changelogUrl: 'https://github.com/bruceblink/KVideo/blob/main/CHANGELOG.md',
  repositoryUrl: 'https://github.com/bruceblink/KVideo',
};
    ...
    >
      <div className="space-y-4">
        ...
        <div className="flex flex-wrap items-center gap-3 text-xs text-[var(--text-color-secondary)]">
          <span>
            检查来源：{data?.source.repository || 'bruceblink/KVideo'} · {data?.source.branch || 'main'}
          </span>
          <Link
            href={data?.source.changelogUrl || 'https://github.com/bruceblink/KVideo/blob/main/CHANGELOG.md'}
            target="_blank"
            rel="noreferrer"
          ...
          <Link
            href={data?.source.repositoryUrl || 'https://github.com/bruceblink/KVideo'}
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center gap-1 text-[var(--accent-color)] hover:underline"
          >
